...
import { update, index } from '@/routes/stock-transfers';
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Edit',
        href: `/stock-transfers/${props.transfer.data.id}/edit`,
    },
];
...
const form = useForm({
    transfer_number: props.transfer.data.transfer_number,
    from_warehouse_id: props.transfer.data.from_warehouse_id,
    to_warehouse_id: props.transfer.data.to_warehouse_id,
    transfer_date: props.transfer.data.transfer_date,
    status: props.transfer.data.status,
    notes: props.transfer.data.notes || '',
    items: (props.transfer.data.items || []).map(item => ({
...
const submit = () => {
    form.put(update.url(props.transfer.data.id));
};
</script>
        ...
        <div class="py-12">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight mb-6">
                    Edit Stock Transfer #{{ form.transfer_number }}
                </h2>
                    ...
                    <form @submit.prevent="submit" class="space-y-6">
                        ...
                        <div class="border-b pb-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <Input id="transfer_number" v-model="form.transfer_number" required maxlength="20" />
                        ...
                        <div class="flex justify-end space-x-2 pt-4">
                            ...
                            <Button type="submit" :disabled="form.processing || form.items.length === 0">
                                {{ form.processing ? 'Updating...' : 'Update Transfer' }}
                            </Button>
                        </div>
                    </form>
                </div>
