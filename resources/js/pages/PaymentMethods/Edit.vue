...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/payment-methods/${props.paymentMethod.id}/edit` },
];
...
const form = useForm({
    ...
    requires_reference: props.paymentMethod.requires_reference,
    is_active: props.paymentMethod.is_active,
});

const submit = () => {
    form.put(`/payment-methods/${props.paymentMethod.id}`);
};
</script>
