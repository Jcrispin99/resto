...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/table-areas/${props.area.id}/edit` },
];

const form = useForm({
    branch_id: props.area.branch_id?.toString() || '',
...
const submit = () => {
    form.put(`/table-areas/${props.area.id}`);
};
</script>

<template>
    <Head title="Edit Table Area" />
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="flex justify-end gap-4 mt-6">
                        ...
                        <Button type="submit" :disabled="form.processing">
                            {{ form.processing ? 'Updating...' : 'Update Area' }}
                        </Button>
                    </div>
                </form>
            </div>
