...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Menú', href: '/menu/categories' },
    { title: 'Editar', href: `/menu/categories/${props.category.id}/edit` },
];

const submit = () => {
    form.put(`/menu/categories/${props.category.id}`);
};
</script>
