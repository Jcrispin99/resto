...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nuevo Producto', href: '/inventory/products/create' },
];
...
const form = useForm({
    ...
    sale_price: 0,
    can_be_sold: false,       // FALSE por defecto para inventario
    can_be_stocked: true,
...
<template>
    <Head title="Nuevo Producto de Inventario" />
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent class="space-y-4">
                            <div class="grid gap-2">
                                ...
                                <Input id="name" v-model="form.name" placeholder="ej: Harina, Aceite, Coca-Cola 500ml" required />
                            ...
                            <div class="grid gap-2">
                                ...
                                <Textarea id="description" v-model="form.description" placeholder="Descripción interna" rows="2" />
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>¿Este producto también se vende en el menú?</CardDescription>
                        </CardHeader>
                        <CardContent class="space-y-4">
                            <div class="flex items-center space-x-2">
                                <Checkbox id="can_be_sold" v-model:checked="form.can_be_sold" />
                                <Label for="can_be_sold" class="cursor-pointer">
                                    También se vende en menú (ej: bebidas)
                                </Label>
                            </div>
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <Label for="can_be_stocked" class="cursor-pointer">
                                    Gestionar stock (variantes almacenables)
                                </Label>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card v-if="form.can_be_stocked">
                        <CardHeader class="flex flex-row items-center justify-between">
                            <div>
                                ...
                                <CardDescription>Define atributos para generar variantes (ej: Tamaño, Presentación)</CardDescription>
                            </div>
