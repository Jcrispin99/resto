...
const form = useForm({
    ...
    // PRINCIPAL: Menu/POS
    menu_category_id: props.template.menu_category_id ? props.template.menu_category_id.toString() : null,
    sale_price: props.template.sale_price ?? 0,
    can_be_sold: props.template.can_be_sold ?? true,
    can_be_stocked: props.template.can_be_stocked ?? true,
    can_be_purchased: props.template.can_be_purchased ?? true,
    
    // OPCIONAL: Inventory category
    has_inventory_category: !!props.template.category_id,
    category_id: props.template.category_id ? props.template.category_id.toString() : null,
    
    product_type: props.template.product_type || 'storable',
    ...
    menu_settings: {
        ...
        calories: props.template.menu_settings?.calories ?? undefined,
        ...
        allergens: props.template.menu_settings?.allergens || [],
        available_for_dine_in: props.template.menu_settings?.available_for_dine_in ?? true,
        available_for_takeout: props.template.menu_settings?.available_for_takeout ?? true,
        available_for_delivery: props.template.menu_settings?.available_for_delivery ?? true,
    },
});
